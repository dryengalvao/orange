...
public class Celula implements AbstractEntity {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4111636050172386261L;
	...
	public static Celula jsonToObject(String json) {
		return new JSONDeserializer<Celula>().use(null, Celula.class)
				.use("membros", ArrayList.class).deserialize(json);
	}
