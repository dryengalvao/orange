...
<body>
    <? echo $menu; ?>
	<div class="col_12">
    	<div class="center"> <h6>Lista de Notas de Empenho de Convênio</h6></div>
        ...
        <div class="right col_7"> 
        	<ul class="button-bar">
              <li><a href="<?php echo site_url('convenio_empenho/principal'); ?>">p/ Exportar</a></li>
              <li><a href="<?php echo site_url('convenio_empenho/exportados'); ?>"> Exportados</a></li>
            </ul>
        </div>
        <br></br>
        <? if(isset($msg)) echo $msg; ?>
    </div>  
    <form action="<?php echo site_url('convenio_empenho/exportar'); ?>" method="post">
					...
					foreach($convenio_empenho as $row){
						echo '<tr> <td heigth="5"> </td> </tr>
                          	  <tr>
								   ...
								   <td> '. $row->nome			  	    .' </td>
								   <td class="center"> <a href="'.site_url("convenio_empenho/editar/".$row->id).'"> <img src="../../img/edit.gif"/> </a></td>
