...
<body>
    <? echo $menu; ?>
	<div class="col_12">
    	<div class="center"> <h6>Lista de Cotações</h6></div>
        <div class="left col_4"><a class="button pop small green" href="<?php echo site_url('cotacoes/novo'); ?>">Cadastrar novo</a></div>
        <div class="right col_7"> 
        	<ul class="button-bar">
              <li><a href="<?php echo site_url('cotacoes/principal'); ?>">p/ Exportar</a></li>
              <li><a href="<?php echo site_url('cotacoes/exportados'); ?>"> Exportados</a></li>
            </ul>
        </div>
        <br></br>
        <? if(isset($msg)) echo $msg;?>
    </div>  
    <form action="<?php echo site_url('cotacoes/exportar'); ?>" method="post">
        ...
        <table class="striped">
            <thead>
                <tr>
                    ...
                    <th> Valor cotado					  </th>
                    <th> Situação do participante         </th>
                    <th> Competência	                  </th>
                    <th> </th>
            ...
            <tbody>
            	...
            	<? 
					foreach($cotacoes as $row){
						if($row->cd_VencedorPerdedor == "V") $situacao = "Vencedor";
						else $situacao = "Perdedor";
						...
						echo '<tr> <td heigth="5"> </td> </tr>
                          	  <tr>
								   ...
								   <td> '. $Cic					        .' </td>
								   <td> '. $row->vl_TotalCotadoItem     .' </td>
								   <td> '. $situacao  					.' </td>
								   <td> '. $row->nome			  	    .' </td>
								   <td class="center"> <a href="'.site_url("cotacoes/editar/".$row->id).'"> <img src="../../img/edit.gif"/> </a></td>
