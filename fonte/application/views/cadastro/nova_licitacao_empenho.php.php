	...
	<div class="col_12">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="sortable">
          <thead>
              <tr>
                 <td>
                 	<form action="<?php echo site_url('licitacao_empenho/inserir'); ?>" method="post">
                    	<table width="100%" cellpadding="0" cellspacing="0">
                        	<tr>
                                <td class="right"> Número da licitação: </td>
                                <td class="left"> 
                                	<select name="nu_licitacao" style="width:150px;" <?php if(form_error('nu_licitacao')) echo 'class="error"';?>>
                                    	<option value=""> </option>
										<? 
