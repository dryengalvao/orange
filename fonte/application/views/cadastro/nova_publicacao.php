	...
	<div class="col_12">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="sortable">
          <thead>
              <tr>
                 <td>
                 	<form action="<?php echo site_url('publicacoes/inserir'); ?>" method="post">
                    	<table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="left"><input type="text" size="5" maxlength="2" name="nu_SequencialPublicacao" value="<?php echo set_value('nu_SequencialPublicacao');?>"<?php if(form_error('nu_SequencialPublicacao')) echo 'class="error"';?>/></td>
                        	
                            	<td class="right"> Nome do veículo de comunicação: </td>
                                <td class="left" colspan="2"> <input type="text" size="60" maxlength="50" name="nm_veiculoComunicacao" value="<?php echo set_value('nm_veiculoComunicacao');?>"<?php if(form_error('nm_veiculoComunicacao')) echo 'class="error"';?>/></td>                            
                            </tr>
