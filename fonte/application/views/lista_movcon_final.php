...
<head>
	...
	<title>Movimento final</title>
</head>
<body>
    <? echo $menu; ?>
	<div class="col_12">
    	<div class="center"> <h6>Lista de Movimentação Final</h6></div>
        <div class="left col_4"><a class="button pop small green" href="<?php echo site_url('movcon_final/novo'); ?>">Cadastrar novo</a></div>
        <div class="right col_7"> 
        	<ul class="button-bar">
              <li><a href="<?php echo site_url('movcon_final/principal'); ?>">p/ Exportar</a></li>
              <li><a href="<?php echo site_url('movcon_final/exportados'); ?>"> Exportados</a></li>
            </ul>
        </div>
        <br></br>
        <? if(isset($msg)) echo $msg;?>
    </div>  
    <form action="<?php echo site_url('movcon_final/exportar'); ?>" method="post">
					...
					foreach($movcon_final as $row){
						echo '<tr> <td heigth="5"> </td> </tr>
                          	  <tr>
								   ...
								   <td> '. $row->nome			  	  .' </td>
								   <td class="center"> <a href="'.site_url("movcon_final/editar/".$row->id).'"> <img src="../../img/edit.gif"/> </a></td>
