	...
	<div class="col_12">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="sortable">
          <thead>
              <tr>
                 <td>
                 	<form action="<?php echo site_url('contrato_empenho/update'); ?>" method="post">
                      <? foreach($contrato_empenho as $row){?>
                    	<table width="100%" cellpadding="0" cellspacing="0">
                        	<tr>
                                <td class="right"> Número do contrato: </td>
                                <td class="left"> 
                                	<select name="nu_Contrato" style="width:150px;">
										<? 
											foreach ($contratos as $c) {
                                				echo "<option value='" . $c->id . "'";
												if(strcmp($c->id, $row->id_nu_contrato) == 0) echo ' selected="selected" ';
												echo "> " . $c->nu_Contrato . " </option>";
                            				}
										?>
                            		</select>
                                </td>
