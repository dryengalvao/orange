...
<body>
	<? echo $menu; ?>
	<div class="col_12">
    	<div class="center"> <h6>Editar movimento mensal</h6></div>
        <div class="left"> <a href="<?php echo site_url('movcon_mensal/principal'); ?>" style="text-decoration:none">Voltar</a></div>
    	</br>
        <table width="100%" cellpadding="0" cellspacing="0" class="sortable">
          <thead>
              <tr>
                 <td>
                 	<form action="<?php echo site_url('movcon_mensal/update'); ?>" method="post">
