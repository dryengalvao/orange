...
<body>
	<? echo $menu; ?>
	<div class="col_12">
    	<div class="center"> <h6>Editar certidão</h6></div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="sortable">
          <thead>
              <tr>
                 <td>
                 	<form action="<?php echo site_url('certidoes/update'); ?>" method="post">
                      <? foreach($certidoes as $row){?>
                    	<table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="left"> 
                                	<select name="tp_Certidao" style="width:150px;">
										<? 
											foreach ($tipo_certidao as $tc) {
                                				echo "<option value='" . $tc->codigo . "'";
												if(strcmp($tc->codigo, $row->tp_Certidao) == 0) echo ' selected="selected" ';
                                ...
                                <td class="left"> <input type="text" size="35" maxlength="60" name="nu_Certidao" value="<?=$row->nu_Certidao;?>"/></td>
                            ...
                            <tr> 
                                ...
                                <td class="left"> <input type="text" size="20" maxlength="10" name="dt_EmissaoCertidao" onkeypress="javascript:formatar(this);" value="<?=$row->dt_EmissaoCertidao;?>"/></td>
                                <td class="right"> Data de validade da certidão: </td>
                                <td class="left"> <input type="text" size="20" maxlength="10" name="dt_ValidadeCertidao" onkeypress="javascript:formatar(this);" value="<?=$row->dt_ValidadeCertidao;?>"/></td>
                            </tr>
