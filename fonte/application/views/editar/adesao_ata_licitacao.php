...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<title>Editar adesão</title>
</head>

<body>
	<? echo $menu; ?>
	<div class="col_12">
    	<div class="center"> <h6>Editar adesão</h6></div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="sortable">
          <thead>
              <tr>
                 <td>
                 	<form action="<?php echo site_url('adesao_ata_licitacao/update'); ?>" method="post">
                      <? foreach($adesao_ata_licitacao as $row){?>
                    	<table width="100%" cellpadding="0" cellspacing="0">
                        	<tr>
                                <td class="right"> Número do processo de compra: </td>
                                <td class="left"> <input type="text" size="30" maxlength="18" name="nu_ProcessoCompra" value="<?=$row->nu_ProcessoCompra;?>"/></td>
                                <td class="right"> Número da ata: </td>
                                <td class="left"> <input type="text" size="30" maxlength="18" name="nu_Ata" value="<?=$row->nu_Ata;?>"/></td>
                            ...
                            <tr>
                                ...
                                <td class="left"> 
                                	<select name="tp_Adesao" style="width:250px;">
                                    	<option value=""> </option>
										<? 
											foreach ($tipo_adesao as $ta) {
                                				echo "<option value='" . $ta->codigo . "'";
												if(strcmp($ta->codigo, $row->tp_Adesao) == 0) echo ' selected="selected" ';
                                ...
                                <td class="left"> <input type="text" size="20" maxlength="10" name="dt_Adesao" value="<?=$row->dt_Adesao;?>" onkeypress="javascript:formatar(this);"/></td>
                                <td class="right"> Data da validade da ata: </td>
                                <td class="left"> <input type="text" size="20" maxlength="10" name="dt_Validade" value="<?=$row->dt_Validade;?>" onkeypress="javascript:formatar(this);" /></td>
                            </tr>
                            <tr> <td height="3"> </td> </tr>
                            <tr>   
                                <td class="right"> Número do Diário Oficial da ata: </td>
                                <td class="left"> <input type="text" size="20" maxlength="6" name="nu_Diario" value="<?=$row->nu_Diario;?>"/></td>
